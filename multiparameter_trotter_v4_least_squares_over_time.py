...
def run_realization(w_true, beta_val, phi, gaussian_noise, w_starts, time_cutoffs):
...
def run_all_betas(w_true):
    ...
    for _ in range(iter // batch_size):
        ...
        batch_results = Parallel(n_jobs=args.n_jobs)(
            delayed(run_realization)(w_true=w_true, beta_val=beta_array[b], phi=phi, gaussian_noise=n,
                                      w_starts=ws, time_cutoffs=time_cutoffs_array)
