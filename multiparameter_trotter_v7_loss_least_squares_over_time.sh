#!/bin/bash
#SBATCH --job-name=mle_over_time_v7_loss
#SBATCH --ntasks=1
#SBATCH --array=0-19
#SBATCH --time=24:00:00
#SBATCH --output=/users/sjqqqqqq/quantum_metrology/slurm_logs/mle_over_time_v7_loss_%A_%a.out
...
outdir="$repo/data_mle_over_time_loss_1/task_${SLURM_ARRAY_TASK_ID}"
mkdir -p "$outdir"
